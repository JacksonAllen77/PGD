...
//        getPicbyPlayCtrl();
    ...
    {
        file = new File(System.getProperty("user.dir") + "\\Download\\Videodatabytime1.mp4");  //保存回调函数的音频数据
        ...
        net_dvr_vod_para.struBeginTime.dwDay=28;
        net_dvr_vod_para.struBeginTime.dwHour=7;
        ...
        net_dvr_vod_para.struEndTime.dwDay=28;
        net_dvr_vod_para.struEndTime.dwHour=7;
...
/*        IntByReference intP=new IntByReference(30*1024);
    ...
    public  void dowmloadRecordByTime(int userID)
    {
        ...
        net_dvr_playcond.dwChannel=38; //通道号 NVR设备路数小于32路的起始通道号从33开始，依次增加
        //开始时间
